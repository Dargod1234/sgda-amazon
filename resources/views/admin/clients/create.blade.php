                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="contract_owner" class="form-control @error('contract_owner') is-invalid @enderror" required>
                            ...
                            <option value="Jennifer" {{ old('contract_owner') == 'Jennifer' ? 'selected' : '' }}>Jennifer</option>
                            <option value="Igamocol" {{ old('contract_owner') == 'Igamocol' ? 'selected' : '' }}>Igamocol</option>
                            <option value="Rodolfo" {{ old('contract_owner') == 'Rodolfo' ? 'selected' : '' }}>Rodolfo</option>
                        </select>
